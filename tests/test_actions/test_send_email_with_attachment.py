...
from actions.send_email_with_attachment.ryax_handler import Mail, MIMEMultipart, handle
...
def test_handle(send_message_mock, configure_mock, mail_init_mock):
    ...
    send_message_mock.assert_called_once_with(
        "subject", "to@email.com", "message", b"attachment file"
    )
...
def test_send_message(multipart_attach):
    ...
    mail.add_attachment = mock.MagicMock()
    mail.send_message("subject", "to@email.com", """message""", b"attachment file")
...
def test_add_attachment():
    ...
    mail.add_attachment(message, attachment_path)
